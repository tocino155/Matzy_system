...
return [
    ...
    */
    ...
    'logo' => "MATZY SYSTEM",
    'logo_img' => 'imagenes/logo3p.png',
    'logo_img_class' => ' brand-image img-circle elevation-3',
    'logo_img_xl' => 'imagenes/logonuevoB.png',
    ...
    */
    ...
    'preloader' => [
        'enabled' => true,
        'img' => [
            'path' => 'imagenes/logo3p.png',
            'alt' => 'CONSTRUCTORA MATZY',
    ...
    */
    ...
    'menu' => [
        ...
        */
        ...
        [
            'text'    => 'Catalogos',
            'icon'    => 'nav-icon fas fa-fw fa-file',
            'submenu' => [
                [
                    'text' => 'Veiculos',
                    'url'  => '/Catalogos',
                    'icon'    => 'nav-icon fas fa-fw fa-caret-right',
                    'icon_color' => 'warning',
                ],
            ],
        ],
